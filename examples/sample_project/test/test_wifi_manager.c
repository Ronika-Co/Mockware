...
static void test_wifi_manager_start_success(void) {
    ...
    nvs_flash_init_fp = mock_nvs_flash_init;
    esp_wifi_start_fp = mock_wifi_start_ok;
...
static void test_wifi_manager_start_wifi_fail(void) {
    ...
    nvs_flash_init_fp = mock_nvs_flash_init;
    esp_wifi_start_fp = mock_wifi_start_fail;
...
static void test_wifi_manager_stop(void) {
    ...
    esp_wifi_stop_fp = mock_wifi_stop_ok;
